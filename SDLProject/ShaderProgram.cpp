...
void ShaderProgram::set_all_keys_collected(bool collected) {
    GLint all_keys_loc = glGetUniformLocation(m_program_id, "allKeysCollected");
    glUniform1i(all_keys_loc, collected ? 1 : 0);
}
